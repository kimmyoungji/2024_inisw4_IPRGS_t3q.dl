...
train_dataset = CocoDetection(img_folder=f'{tc.T3QAI_TRAIN_DATA_PATH}/dataset/np/train', processor=processor)
val_dataset = CocoDetection(img_folder=f'{tc.T3QAI_TRAIN_DATA_PATH}/dataset/np/val', processor=processor, train=False)
...
def exec_train():
  ...
  model_save_path = f"{tc.T3QAI_TRAIN_MODEL_PATH}/models/np_model.pt"
