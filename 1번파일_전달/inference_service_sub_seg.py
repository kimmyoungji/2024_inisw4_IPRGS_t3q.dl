...
import inference_utils.segmentations as seg
...
#                 segment_id = segments_infos[i]['label_id']
#                 result_dict['label'] = model.config.id2label[segment_id]
#                 result_dict['mask_image'] = seg.get_mask(segment_id, segmentations)
#                 result_dict['mask'] = seg.base64_encoding(seg.set_mask(segment_id, segmentations))
#                 output3.append(result_dict)
...
#     postprocessed_result.append({ "seg_image": seg_image, "areas":areas, "car_bbox":car_bbox, "seg_result":seg_result, "seg_error":seg_error,"output3": output3})
